...
julia --project=core/NeoPKPDCore docs/examples/use_cases/real_world_theophylline/run.jl

# Validate outputs
julia --project=core/NeoPKPDCore docs/examples/use_cases/real_world_theophylline/validate.jl
```
