...
julia --project=core/NeoPKPDCore docs/examples/use_cases/bioequivalence_study/run.jl

# Validate outputs
julia --project=core/NeoPKPDCore docs/examples/use_cases/bioequivalence_study/validate.jl
```
